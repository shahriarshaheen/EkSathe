          ...
          {triggered ? (
            ...
            <>
              <button
                onClick={handleSOS}
                disabled={triggering}
                className={`w-40 h-40 rounded-full flex flex-col items-center justify-center gap-2 font-bold text-white text-xl shadow-lg transition-all select-none
                  ${triggering ? "bg-red-300 scale-95 cursor-not-allowed" : "bg-red-500 hover:bg-red-600 active:scale-95 hover:shadow-xl"}`}
              >
                {triggering ? (
                  <>
        ...
        <div className="bg-white rounded-xl border border-stone-200 p-5">
          ...
          {!loading && contacts.length === 0 && !showAddForm && (
            <div className="text-center py-6">
              <Mail className="w-8 h-8 text-stone-200 mx-auto mb-3" />
          ...
          {showAddForm && (
            <div className="border border-stone-200 rounded-xl p-4 mt-3">
              <div className="flex items-center justify-between mb-4">
              ...
              <div className="space-y-3">
                <div>
                  <input
                    ...
                    className="w-full rounded-lg border border-stone-300 px-3 py-2.5 text-sm placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-teal-600 focus:border-transparent"
                  />
                  {formErrors.name && (
                ...
                <button
                  ...
                  disabled={addLoading}
                  className="w-full bg-stone-900 text-white text-sm font-semibold py-2.5 rounded-lg hover:bg-stone-800 transition-colors disabled:opacity-50"
                >
